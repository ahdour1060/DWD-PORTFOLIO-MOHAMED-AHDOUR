...
## Opgave
In deze oefening ga je gegevens ophalen via de api van songsterr.
Meer info over deze api vind je op https://www.songsterr.com/a/wa/api

Deze oefening bestaat uit een aantal delen :
  * het ophalen van de gegevens zelf met fetch
  * de (json) gegevens gebruiken om de table met gegevens te vullen
